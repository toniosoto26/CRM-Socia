CREATE DATABASE  IF NOT EXISTS `socia` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `socia`;
...
CREATE TABLE `crm_quotation` (
  ...
  `crm_address_id` int(11) NOT NULL,
  `crm_contact_id` int(11) NOT NULL,
  `crm_quotation_detail_id` int(11) NOT NULL,
  ...
  KEY `fk_crm_quotation_crm_quotation_detail1_idx` (`crm_quotation_detail_id`),
  ...
  CONSTRAINT `fk_crm_quotation_crm_quotation_detail1` FOREIGN KEY (`crm_quotation_detail_id`) REFERENCES `crm_quotation_detail` (`crm_quotation_detail_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `crm_quotation_detail` (
  `crm_quotation_detail_id` int(11) NOT NULL,
  `crm_item_id` int(11) NOT NULL,
  `unit price` decimal(12,2) DEFAULT NULL,
...
INSERT INTO `crm_users` VALUES (1,'Admin','1234','Administrador','Socia','admin@socia.com.mx',NULL);
...
-- Dump completed on 2016-10-04  0:18:11
